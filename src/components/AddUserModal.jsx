...
export default function AddUserModal({ isOpen, onClose, onAdd }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onAdd({ ...formData, id: Date.now().toString(), attendance: 0, score: "0%" });
    onClose();
    setFormData({ name: '', role: 'Student', email: '', phone: '', batch: '', department: '', photo: '' });
  };
      ...
      <div className="animate-fade-in" style={{ 
        ...
        <div style={{ 
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 style={{ margin: 0, fontSize: '1.75rem', fontWeight: 900, color: 'white', letterSpacing: '-0.02em' }}>Create New Member</h2>
              <p style={{ margin: '4px 0 0 0', fontSize: '1rem', color: 'rgba(255, 255, 255, 0.8)', fontWeight: 500 }}>Expand your academy's community</p>
            </div>
          </div>
        </div>
            ...
            <div style={inputGroupStyle}>
              ...
              <div style={inputWrapperStyle}>
                ...
                <input 
                  ...
                  style={inputStyle}
                  onFocus={(e) => { e.target.style.borderColor = '#6366F1'; e.target.style.backgroundColor = 'white'; e.target.style.boxShadow = '0 0 0 4px rgba(99, 102, 241, 0.1)'; }}
